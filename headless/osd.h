...
// Remove SDL-specific input update
// #define osd_input_update sdl_input_update

// Instead, declare the function that will handle input in the headless version
void headless_input_update(void);
#define osd_input_update headless_input_update
